...
app.post('/authors/:id');
app.post('/authors');
app.post('/authors/:id/delete');

// Author -> Blog Routes

// Browse blogs for author
app.get('/authors/:id/blogs');

// Delete every blog for an author
app.post('/authors/:id/blogs/delete');

// Update blog for author
app.post('/authors/:id/blogs/:blogId');
